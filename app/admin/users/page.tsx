...
import { listUsersForAdmin } from "@/lib/user-db";
    ...
    <main className="mx-auto max-w-7xl px-4 pb-16 pt-24 sm:px-6 lg:px-8">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-3 font-display text-3xl font-bold sm:text-5xl">Пользователи</h1>
        </div>
      ...
      <AdminUsersTable users={listUsersForAdmin()} currentUserId={user.id} />
    </main>
  );
}
